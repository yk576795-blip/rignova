...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-white/8 bg-surface/50 font-medium [&>tr]:last:border-b-0", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle text-xs font-medium text-muted tracking-wide [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
